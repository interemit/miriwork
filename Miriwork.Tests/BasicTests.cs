...
{
    public class BasicTests : IClassFixture<WebApplicationFactory<Example.Simple.Startup>>
    {
        private readonly WebApplicationFactory<Example.Simple.Startup> factory;

        public BasicTests(WebApplicationFactory<Example.Simple.Startup> factory)
        {
